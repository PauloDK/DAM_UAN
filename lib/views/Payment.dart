...
import 'package:bikesharemobile/models/CreditCard.dart';
import 'package:bikesharemobile/viewmodels/CreditCardViewModel.dart';
import 'package:bikesharemobile/viewmodels/RentalViewModel.dart';
                      ...
                      child: Column(
                        ...
                        children: [
                          Container(
                            ...
                            child:
                                Image.asset('assets/images/visa-pay-logo.png'),
                          ),
                          Center(
                            child: Text(
                        ...
                        children: [
                          Column(
                            ...
                            children: [
                              Info(
                                  label: "Bike ID",
                                  value: bike.id.toString().substring(1, 5)),
                              Info(label: "Bike Type", value: bike.designacao),
                            ],
                          ),
                          Column(
                            crossAxisAlignment: CrossAxisAlignment.start,
                            children: [
                              Info(label: "Bike Owner", value: bike.proprietario),
                              Info(label: "Phone Number", value: bike.tipologia),
                            ],
                          ),
                        ],
                      ),
                              ...
                              showDialog(
                                  ...
                                  builder: (context) {
                                    return PopUp(
                                        ...
                                        description:
                                            "Please confirm your payment from here",
                                        btn1: "No, I don't",
                                        btn2: "I confirm",
                                        onPressed1: () {
                                        ...
                                        onPressed2: () async {
                                          ...
                                          code =
                                              vm.rent(bike.id, days, bike.preco)
                                                  as String;
                                          Navigator.of(context).pop();
                                          showDialog(
                                              context: context,
                                                  ...
                                                  title: const Center(
                                                    child: Text(
                                                        ...
                                                        style: TextStyle(
                                                          fontFamily: 'Poppins',
                                                          color:
                                                              const Color.fromARGB(255, 15, 232, 26),
                                                          fontSize: 16,
                                                          fontWeight:
                                                              FontWeight.w500,
                                                        )),
